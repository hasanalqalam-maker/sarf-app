...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-ink border-t border-gold/10">
      <ul className="flex">
        {NAV_ITEMS.map((item) => {
            ...
            <li key={item.href} className="flex-1">
              <Link
                ...
                className={`
                  ...
                  ${isActive ? 'text-teal-light' : 'text-parchment/50 hover:text-parchment/80'}
                `}
              >
