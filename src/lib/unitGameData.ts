...
export const UNIT4_GAMES: GameConfig[] = [
  { id: 'u4-madi-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Māḍī Maʿlūm', description: 'Reveal all 14 māḍī forms for each mithāl example verb.', type: 'fill-table', format: 'fill-table', paradigm: 'madi_malum', unlockAfter: [] },
  { id: 'u4-mudari-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Muḍāriʿ Maʿlūm', description: 'Reveal all 14 muḍāriʿ forms — watch for the ḥaḏf/qalb changes.', type: 'fill-table', format: 'fill-table', paradigm: 'mudari_malum', unlockAfter: ['u4-madi-fill'] },
  { id: 'u4-majhul-madi-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Māḍī Majhūl', description: 'Reveal the passive māḍī table for each verb.', type: 'fill-table', format: 'fill-table', paradigm: 'madi_majhul', unlockAfter: ['u4-mudari-fill'] },
  ...
  { id: 'u4-bab-flashcards', unit: 4, section: 'التَّعَرُّف عَلَى الأَبْوَاب', title: 'Flashcards — Mithāl Verbs', description: 'Review the mithāl example verbs with flip cards.', type: 'flashcards', format: 'flashcards', paradigm: 'madi_malum', unlockAfter: ['u4-amr-fill'] },
