...
export const UNIT4_SECTION_ORDER = ['التَّصْرِيْف', 'التَّعَرُّف عَلَى الأَبْوَاب'];

export const UNIT4_GAMES: GameConfig[] = [
  { id: 'u4-madi-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Māḍī Maʿlūm', description: 'Reveal all 14 māḍī forms for each of the 21 mithāl example verbs.', type: 'fill-table', format: 'fill-table', paradigm: 'madi_malum', unlockAfter: [] },
  { id: 'u4-mudari-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Muḍāriʿ Maʿlūm', description: 'Reveal all 14 muḍāriʿ forms — watch for the ḥaḏf/qalb/idḡẖām changes.', type: 'fill-table', format: 'fill-table', paradigm: 'mudari_malum', unlockAfter: ['u4-madi-fill'] },
  { id: 'u4-majhul-madi-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Māḍī Majhūl', description: 'Reveal the passive māḍī table for each verb (most take one — a couple are intransitive).', type: 'fill-table', format: 'fill-table', paradigm: 'madi_majhul', unlockAfter: ['u4-mudari-fill'] },
  { id: 'u4-majhul-mudari-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Muḍāriʿ Majhūl', description: 'Reveal the passive muḍāriʿ table for each verb.', type: 'fill-table', format: 'fill-table', paradigm: 'mudari_majhul', unlockAfter: ['u4-majhul-madi-fill'] },
  { id: 'u4-amr-fill', unit: 4, section: 'التَّصْرِيْف', title: 'Fill the Table — Amr', description: 'Reveal all 6 command forms for each verb.', type: 'fill-table', format: 'fill-table', paradigm: 'amr', unlockAfter: ['u4-majhul-mudari-fill'] },
  { id: 'u4-bab-flashcards', unit: 4, section: 'التَّعَرُّف عَلَى الأَبْوَاب', title: 'Flashcards — Mithāl Verbs', description: 'Review all 21 mithāl example verbs (wāwī and yāʾī) with flip cards.', type: 'flashcards', format: 'flashcards', paradigm: 'madi_malum', unlockAfter: ['u4-amr-fill'] },
  { id: 'u4-bab-mudari-matchup', unit: 4, section: 'التَّعَرُّف عَلَى الأَبْوَاب', title: 'Match: Māḍī ↔ Muḍāriʿ', description: 'Match each mithāl māḍī form to its muḍāriʿ counterpart.', type: 'match-up', format: 'match-up', paradigm: 'mudari_malum', matchType: 'bab-mudari', unlockAfter: ['u4-bab-flashcards'] },
  { id: 'u4-which-bab-madi', unit: 4, section: 'التَّعَرُّف عَلَى الأَبْوَاب', title: 'Which Verb? — Māḍī', description: 'Given a māḍī form, identify which mithāl example it belongs to.', type: 'which-bab', format: 'quiz', paradigm: 'madi_malum', unlockAfter: ['u4-bab-mudari-matchup'] },
];

REGISTRIES[4] = UNIT4_GAMES;
SECTION_ORDERS[4] = UNIT4_SECTION_ORDER;
