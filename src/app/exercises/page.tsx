...
export default function ExercisesPage() {
  return (
    <div className="px-6 py-10 max-w-xl">
      <h1 className="font-heading text-3xl text-ink mb-1">Exercises</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/exercises/unit-1" className="card-parchment p-5 hover:border-gold/40 transition-colors group block">
        ...
        <div className="card-parchment p-5 opacity-40 cursor-not-allowed">
